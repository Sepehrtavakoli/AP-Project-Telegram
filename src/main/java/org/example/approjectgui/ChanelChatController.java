...
//        if (currentChanel == null || !isCreator) {
//            return;
//        }
//
//        String messageText = messageInput.getText().trim();
//        if (!messageText.isEmpty() && client != null && client.isConnected()) {
//            // ایجاد یک آبجکت پیام استاندارد
//            Message channelMessage = new Message(
//                    UserData.currentUser.getUserId(),
//                    currentChanel.getChanelID(), // <-- ID کانال را در receiverId قرار می‌دهیم
//                    messageText,
//                    Message.MessageType.TEXT
//            );
//
//            // ذخیره پیام در دیتابیس (اختیاری، چون سرور هم این کار را می‌کند)
//            DatabaseHelper.saveChanelMessage(currentChanel.getChanelID(), channelMessage);
//
//            // استفاده از متد جدید برای ارسال پیام کانال
//            client.sendChannelMessage(channelMessage, currentChanel.getChanelID());
//
//            // نمایش فوری پیام در UI خودمان
